...
class TipoMantenimientoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $obligatorios2 = $request->input('obligatorio', []);
...
//        $productos = $request->input('productos', []);
    ...
    public function detallerango($kilometraje)
    {
        $tipoMantenimiento = TipoMantenimiento::where('LimiteInferiorKilometraje', '<=' ,$kilometraje )-> where('LimiteSuperiorKilometraje', '>=' ,$kilometraje )->first();
        //$detalle = TipoMantenimientoDetalle::findOrFail($id);
        $detalle = TipoMantenimientoDetalle::with('actividadmantenimiento')->where('IdTipoMantenimiento','=',$tipoMantenimiento->IdTipoMantenimiento )->get();
        return response($detalle);
    }
}
