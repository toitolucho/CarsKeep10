                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('ci') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('ci') ? ' is-invalid' : '' }}" name="ci" id="input-ci" type="text" placeholder="{{ __('Carnet de Identidad') }}" value="{{ old('ci', $cliente->ci) }}" required="true" aria-required="true"/>
                                            @if ($errors->has('ci'))
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('Nombres') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('Nombres') ? ' is-invalid' : '' }}" name="Nombres" id="input-Nombres" type="text" placeholder="{{ __('Nombres') }}" value="{{ old('Nombres', $cliente->Nombres) }}" required="true" aria-required="true"/>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('Apellidos') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('Apellidos') ? ' is-invalid' : '' }}" name="Apellidos" id="input-Apellidos" type="text" placeholder="{{ __('Apellidos') }}" value="{{ old('Apellidos', $cliente->Apellidos) }}" required />
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-sm-7">
                                            <div class="form-group{{ $errors->has('NroCelular') ? ' has-danger' : '' }}">
                                                <input class="form-control{{ $errors->has('NroCelular') ? ' is-invalid' : '' }}" name="NroCelular" id="input-NroCelular" type="text" placeholder="{{ __('Nro Celular') }}" value="{{ old('NroCelular', $cliente->NroCelular) }}" required />
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('CorreoElectronico') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('CorreoElectronico') ? ' is-invalid' : '' }}" name="CorreoElectronico" id="input-CorreoElectronico" type="email" placeholder="{{ __('Correo Electronico') }}" value="{{ old('CorreoElectronico', $cliente->CorreoElectronico) }}"  />
