...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('tiposmantenimientos.store') }}" autocomplete="off" class="form-horizontal" id="tiposmaneniento" novalidate>
                        @csrf
{{--                        @method('put')--}}
        ...
        $(document).ready(function() {
            ...
            $("#buscarServicio").typeahead({
                ...
                var markup = "<tr id=articulo" +(NroServicios+1)+">" +
                    ...
                    "<td class='w-15 text-right'> <input type='hidden' name='obligatorio[" +(NroServicios)+"]' value='0' />  <input type='checkbox' name='obligatorio[" +(NroServicios)+"]' class='form-control small-checkbox'  value='1' checked/></td>"+
