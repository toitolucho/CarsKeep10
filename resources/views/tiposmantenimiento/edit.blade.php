@extends('layouts.app', ['activePage' => 'Tipos_Mantenimiento', 'titlePage' => __('Edición de Tipos de Mantenimiento')])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                {{--                <h1>{{$tipomantenimiento->NombreMantenimiento}}</h1>--}}
                <div class="col-md-12">
                    <form method="post"
                          action="{{ route('tiposmantenimientos.update', $tipoMantenimiento->IdTipoMantenimiento) }}"
                          autocomplete="off" class="form-horizontal" id="tiposmaneniento">
                        @csrf
                        @method('put')
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="form-group{{ $errors->has('NombreMantenimiento') ? ' has-danger' : '' }}">
                                                            <input class="form-control{{ $errors->has('NombreMantenimiento') ? ' is-invalid' : '' }}"
                                                                   ...
                                                                   value="{{ old('NombreMantenimiento', $tipoMantenimiento->NombreMantenimiento) }}"
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="form-group{{ $errors->has('LimiteInferiorKilometraje') ? ' has-danger' : '' }}">
                                                            <input class="form-control{{ $errors->has('LimiteInferiorKilometraje') ? ' is-invalid' : '' }}"
                                                                   ...
                                                                   value="{{ old('LimiteInferiorKilometraje', $tipoMantenimiento->LimiteInferiorKilometraje) }}"
                                                                   required="true" aria-required="true"/>
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="form-group{{ $errors->has('LimiteSuperiorKilometraje') ? ' has-danger' : '' }}">
                                                            <input class="form-control{{ $errors->has('LimiteSuperiorKilometraje') ? ' is-invalid' : '' }}"
                                                                   ...
                                                                   value="{{ old('LimiteSuperiorKilometraje', $tipoMantenimiento->LimiteSuperiorKilometraje) }}"
                                                                   required="true" aria-required="true"/>
            ...
            {{--                                                <input class="form-control{{ $errors->has('Descripcion') ? ' is-invalid' : '' }}" name="Descripcion" id="input-Descripcion" type="text" placeholder="{{ __('Descripcion') }}" value="{{ old('Descripcion', $tipoMantenimiento->Descripcion) }}" required />--}}
                                                            <textarea class="form-control {{ $errors->has('Descripcion') ? ' is-invalid' : '' }}" name="Descripcion" id="input-Descripcion" rows="3">{{old('Descripcion', $tipoMantenimiento->Descripcion)}}</textarea>
                                                ...
                                                <div class="row  mt-3 ml-1">
                                                    <div class="col-md-12">
                                                        <table class="table table-bordered table-hover" id="tabla_servicios">
                                                            ...
                                                            <tbody>
                                                                @foreach($tipoMantenimiento->actividadesmantenimiento as $detalle)
...
{{--                                                                        <td class='w-10 text-right'> <input type='hidden' name='obligatorio[{{$loop->index}}]' value='' />  <input type='checkbox' name='obligatorio[{{$loop->index+1}}]' class='form-control small-checkbox'  value="{{$detalle->pivot->Obligatorio=='1' ? true : false}}" {{$detalle->pivot->Obligatorio=='1' ?  'checked' : ''}}/></td>--}}
                                                                        <td class='w-10 text-right'> <input type='hidden' name='obligatorio[{{$loop->index}}]' value='0' />  <input type='checkbox' name='obligatorio[{{$loop->index}}]' class='form-control small-checkbox'  value='1' {{$detalle->pivot->Obligatorio=='1' ?  'checked' : ''}}/></td>
...
@push('js')
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            var NroServicios={!! $tipoMantenimiento->actividadesmantenimiento_count !!};
