                    ...
                    <form method="post" action="{{ route('ingresosarticulos.update', $ingreso->IdIngresoArticulo) }}" autocomplete="off" class="form-horizontal" id="compraarticulos">
                        ...
                        <div class="card ">
                            <div class="card-header card-header-primary">
                                ...
                                <p class="card-category">{{ __('Actualize los datos de la compra') }}</p>
                            </div>
                            <div class="card-body ">
                                @if (session('status'))
                                    <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="form-group{{ $errors->has('IdProveedor') ? ' has-danger' : '' }}">
                                                            ...
                                                            <input type="hidden" name="IdProveedor"   value="{{ old('IdProveedor', $ingreso->IdProveedor) }}"  required />
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="form-group{{ $errors->has('FechaHoraRegistro') ? ' has-danger' : '' }}">
                                                            <input class="form-control{{ $errors->has('FechaHoraRegistro') ? ' is-invalid' : '' }}" name="FechaHoraRegistro" id="input-FechaHoraRegistroa" type="date" placeholder="{{ __('Fecha de Registro') }}" value="{{ old('FechaHoraRegistro', \Carbon\Carbon::parse($ingreso->FechaHoraRegistro )->format('Y-m-d')) }}" required="true" aria-required="true"/>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <div class="form-group{{ $errors->has('Observaciones') ? ' has-danger' : '' }}">
                                                            ...
                                                            <textarea class="form-control {{ $errors->has('Observaciones') ? ' is-invalid' : '' }}" name="Observaciones" id="input-Observaciones" rows="3">{{ old('Observaciones', $ingreso->Observaciones) }}</textarea>
                                                            <span class="bmd-help">descripción que describa de forma general el ingreso</span>
                                                ...
                                                <div class="row  mt-3 ml-1">
                                                    <div class="col-md-12 ">
                                                        <table class="table table-bordered table-hover" id="tabla_articulos">
                                                            ...
                                                            <tbody>
                                                                @foreach($ingreso->articulos as $detalle)
...
{{--                                                                        <td><input type='text' name='productos[]' class='form-control' value ="{{$detalle->articulo->NombreArticulo}}"  readonly/></td>--}}
                                                                        ...
                                                                        <td><input type='number' name='total[]' placeholder='0.00' class='form-control total'  value="{{ $detalle->pivot->Cantidad*$detalle->pivot->Precio }}" readonly/></td>
...
@push('js')
    <script>
        $(document).ready(function() {
            ...
            var NroArticulos={!! $ingreso->articulos_count !!};
            $('#input-CodigoEstadoIngreso').val("{!!  $ingreso->CodigoEstadoIngreso  !!}");
            // $("#tabs").tabs();
            ...
            $("#buscarArticulo").typeahead({
                ...
                //console.log( "Nro Fila " +  (NroArticulos+1));
